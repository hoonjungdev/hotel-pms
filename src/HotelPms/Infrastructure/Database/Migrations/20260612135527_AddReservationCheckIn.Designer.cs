...
namespace HotelPms.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260612135527_AddReservationCheckIn")]
    partial class AddReservationCheckIn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HotelPms.Features.Reservations.Domain.Reservation", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "StayPeriod", "HotelPms.Features.Reservations.Domain.Reservation.StayPeriod#DateRange", b1 =>
                        {
                            b1.IsRequired();
