...
public class CreateRoomTypeHandlerTests
{
    ...
    public async Task HandleAsync_ValidCommand_PersistsRoomType()
    {
        ...
        var command = new CreateRoomTypeCommand(tenantId, " dbl ", "  Double  ", 2, 4, 120_000, "KRW");
        ...
        Assert.Equal(new Money(120_000, Currency.KRW), result.BaseNightlyRate);
    }
    ...
    {
        var tenantId = TenantId.New();
        var first = new CreateRoomTypeCommand(tenantId, "dbl", "Double", 2, 4, 120_000, "KRW");
        var second = new CreateRoomTypeCommand(tenantId, " DBL ", "Deluxe Double", 2, 4, 150_000, "KRW");
    ...
    {
        var first = new CreateRoomTypeCommand(TenantId.New(), "dbl", "Double", 2, 4, 120_000, "KRW");
        var second = new CreateRoomTypeCommand(TenantId.New(), "DBL", "Double", 2, 4, 120_000, "KRW");
    ...
    {
        var command = new CreateRoomTypeCommand(TenantId.New(), "dbl", "Double", 3, 2, 120_000, "KRW");
